  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-50 text-zinc-900">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6">
        <div className="grid gap-6 items-stretch lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
          ...
          <aside className="flex h-[420px] w-full flex-col rounded-2xl border border-zinc-300 bg-white shadow-xl ring-1 ring-zinc-200/50 overflow-hidden sm:h-[480px] lg:h-[520px]">
            ...
            <div
              ...
              className="flex-1 min-h-0 overflow-y-auto px-6 py-4 scroll-smooth bg-zinc-50/30"
            >
              {logs.length === 0 ? (
          ...
          <div className="space-y-5">
            <div className="border-b border-zinc-200 pb-4">
              ...
              <p className="text-sm text-zinc-600 mt-1.5">
                ...
                available • Select one to validate
              </p>
            </div>
